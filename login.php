...
$data = array(); 
$sql = "SELECT `id`, `email`, `name`, `mobile_num`, `email_verified_at` FROM users WHERE email = '$email' and password = '$password';";
 
$stmt = $conn->prepare($sql);
$stmt->execute();
$stmt->bind_result($id, $email, $name, $mobile_num, $email_verified_at);
